...
CREATE DATABASE USERDB_B_P01_LAK;
CREATE SCHEMA USERDB_B_P01_LAK.USER_SMCB_01;
CREATE STAGE USERDB_B_P01_LAK.USER_SMCB_01.STREAMLIT_STAGE;
...
```sql
CREATE OR REPLACE STREAMLIT USERDB_B_P01_LAK.USER_SMCB_01.BENCHMARK_PERIODS_MANAGER
  ROOT_LOCATION = '@USERDB_B_P01_LAK.USER_SMCB_01.STREAMLIT_STAGE/BENCHMARK_PERIODS_MANAGER'
  MAIN_FILE = 'app.py'
...
```sql
CREATE OR REPLACE STREAMLIT USERDB_B_P01_LAK.USER_SMCB_01.UPLOADER_XLSX
  ROOT_LOCATION = '@USERDB_B_P01_LAK.USER_SMCB_01.STREAMLIT_STAGE/UPLOADER_XLSX'
  MAIN_FILE = 'app.py'
  QUERY_WAREHOUSE = STREAMLIT_WH;
```
...
```sql
CREATE OR REPLACE STREAMLIT USERDB_B_P01_LAK.USER_SMCB_01.EVENT_PLAN_WORKBOOK_BUILDER
  ROOT_LOCATION = '@USERDB_B_P01_LAK.USER_SMCB_01.STREAMLIT_STAGE/EVENT_PLAN_WORKBOOK_BUILDER'
  MAIN_FILE = 'app.py'
  QUERY_WAREHOUSE = STREAMLIT_WH;
```
