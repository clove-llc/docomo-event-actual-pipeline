...
select
    facility_code,
    facility_name,(round(max(case when date_flag = 'GW' then foot_traffic_avg end)))::number(38,1) as gw_foot_traffic_avg,(round(max(case when date_flag = 'お盆' then foot_traffic_avg end)))::number(38,1) as obon_foot_traffic_avg,(round(max(case when date_flag = '三連休' then foot_traffic_avg end)))::number(38,1) as three_day_holiday_foot_traffic_avg,(round(max(case when date_flag = '正月' then foot_traffic_avg end)))::number(38,1) as new_year_foot_traffic_avg,(round(max(case when date_flag = '通常土日' then foot_traffic_avg end)))::number(38,1) as regular_weekend_foot_traffic_avg,(round(max(case when date_flag = '年末' then foot_traffic_avg end)))::number(38,1) as year_end_foot_traffic_avg,(round(max(case when date_flag = '飛び石祝日' then foot_traffic_avg end)))::number(38,1) as bridge_holiday_foot_traffic_avg,(round(max(case when date_flag = '平日' then foot_traffic_avg end)))::number(38,1) as weekday_foot_traffic_avg,(round(max(case when date_flag = 'ブラックフライデー' then foot_traffic_avg end)))::number(38,1) as black_friday_foot_traffic_avg,
