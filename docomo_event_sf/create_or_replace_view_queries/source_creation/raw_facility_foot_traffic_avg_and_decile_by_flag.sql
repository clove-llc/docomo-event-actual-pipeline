create or replace view USERDB_B_P01_LAK.USER_SMCB_01.raw_facility_foot_traffic_avg_and_decile_by_flag as
(
with
...
daily_foot_traffic as (
    ...
    join USERDB_B_P01_LAK.USER_SMCB_01.RAW_KDDI_FOOT_TRAFFIC k
