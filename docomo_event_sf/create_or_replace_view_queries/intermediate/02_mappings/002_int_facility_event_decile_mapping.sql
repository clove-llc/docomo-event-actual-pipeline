  ...
  create or replace   view USERDB_D_P01_LAK.USER_SMCB_01.int_facility_event_decile_mapping
  ...
  as (
    ...
    from USERDB_D_P01_LAK.USER_SMCB_01.stg_facility_foot_traffic_avg_and_decile_by_flag
    union all
    select
        facility_code,
        facility_name,
