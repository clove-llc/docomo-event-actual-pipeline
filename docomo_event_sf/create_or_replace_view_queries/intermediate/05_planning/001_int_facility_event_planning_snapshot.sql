create or replace view USERDB_B_P01_LAK.USER_SMCB_01.int_facility_event_planning_snapshot as (
with date_flags as (
    select s_d_m.date_flag
    from USERDB_B_P01_LAK.USER_SMCB_01.stg_date_master as s_d_m
...
all_pattern as (
    ...
    cross join USERDB_B_P01_LAK.USER_SMCB_01.RAW_BENCHMARK_PERIODS as i_b_p
    cross join date_flags as d_f
    left join USERDB_B_P01_LAK.USER_SMCB_01.int_facility_event_decile_mapping as i_f_e_d_m
...
base as (
    ...
    from all_pattern
    left join USERDB_B_P01_LAK.USER_SMCB_01.int_event_decile_benchmark as i_e_d_b
    ...
    left join USERDB_B_P01_LAK.USER_SMCB_01.int_facility_event_decile_avg_actual as i_f_e_d_a_a
