...
create or replace view USERDB_B_P01_LAK.USER_SMCB_01.fact_facility_performance_slots_view as (
with planning_snapshot_all_period as (
    ...
    from USERDB_B_P01_LAK.USER_SMCB_01.int_facility_event_planning_snapshot
...
base as (
    select
        ...
        s_d_m.date_flag
    from USERDB_B_P01_LAK.USER_SMCB_01.stg_facility_master as s_f_m
    cross join USERDB_B_P01_LAK.USER_SMCB_01.stg_date_master as s_d_m
    cross join USERDB_B_P01_LAK.USER_SMCB_01.RAW_BENCHMARK_PERIODS as p
),
...
calc as (
    ...
    from base as b
    left join USERDB_B_P01_LAK.USER_SMCB_01.int_facility_event_planning_snapshot as f_e_p_s
    ...
    -- 施設 × 月番号 × 週番号 × 日付フラグ
    left join USERDB_B_P01_LAK.USER_SMCB_01.int_facility_monthly_weekday_dateflag_deviation_zscore as i_f_m_w_d_z
    ...
    -- 施設 × 月番号 × 日付フラグ
    left join USERDB_B_P01_LAK.USER_SMCB_01.int_facility_monthly_dateflag_deviation_zscore as i_f_m_d_z
        on b.facility_code = i_f_m_d_z.facility_code
       and b.month = i_f_m_d_z.month
       and b.date_flag = i_f_m_d_z.date_flag
    -- 施設 × 月 × 三連休
    left join USERDB_B_P01_LAK.USER_SMCB_01.int_facility_monthly_dateflag_deviation_zscore as i_f_m_3h
        on b.facility_code = i_f_m_3h.facility_code
       and b.month = i_f_m_3h.month
       and i_f_m_3h.date_flag = '三連休'
    -- 施設 × 月 × 通常土日
    left join USERDB_B_P01_LAK.USER_SMCB_01.int_facility_monthly_dateflag_deviation_zscore as i_f_m_d_g_z
        on b.facility_code = i_f_m_d_g_z.facility_code
       and b.month = i_f_m_d_g_z.month
       and i_f_m_d_g_z.date_flag = '通常土日'
    left join USERDB_B_P01_LAK.USER_SMCB_01.int_facility_target_cpa_by_facility AS i_f_t
