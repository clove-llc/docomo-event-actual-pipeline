# raw_facility_foot_traffic_avg_and_decile_by_flag 数値検証
...
## 2. 対象
- 比較元（Snowflake）: `HARATO.RAW.RAW_FACILITY_FOOT_TRAFFIC_AVG_AND_DECILE_BY_FLAG`
